...
$( We will use the following descriptive terms very loosely:  A 'theorem'
  ...
  ${
    ...
    $( First of 2 premises for ~ syl . $)
    syl.2 $e |- ( ps -> ch ) $.
    $( Syllogism inference.  (A bit of trivia: this is the most commonly
       referenced assertion in our database.  In second place is ~ ax-mp ,
       followed by ~ visset , ~ bitr , ~ imp , and ~ exp .  The Metamath
       program command 'show usage' shows the number of references.) $)
    syl $p |- ( ph -> ch ) $=
  ...
  $( A closed form of syllogism.  Theorem *2.05 of [WhiteheadRussell]
     p. 100. $)
  syl1 $p |- ( ( ph -> ps ) -> ( ( ch -> ph ) -> ( ch -> ps ) ) ) $=
    ( wi ax-1 a2d ) ABDZCABGCEF $.
    $( [5-Aug-93] $)

  $( A closed form of syllogism.  Theorem *2.06 of [WhiteheadRussell]
     p. 100. $)
...
$( This section makes our first use of the third axiom of propositonal
  ...
  $( The Inversion Axiom of the infinite-valued sentential logic (L-infinity)
     ...
     expresses "disjunction commutes." $)
  ...
  ${
    ...
    pm2.65d $p |- ( ph -> -. ps ) $=
      ( wi wn pm2.65 syl13 ) BCFBCGFBGABCHDEI $.
      $( [26-Jun-94] $)
  $}
  ...
  ${
    ...
    jc $p |- ( ph -> -. ( ps -> -. ch ) ) $=
      ( wn wi pm3.2im syl13 ) BCBCFGFABCHDEI $.
      $( [5-Aug-93] $)
  $}
...
$)
  ...
  $( This is our first definition, which defines the biconditional connective
     ...
     allows us to use logic to manipulate definitions directly ( ~ df-or is
     its first use).  Here we use the biconditional connective to define
     itself, a feat which requires a little care.  We define ` ( ph <-> ps ) `
     as ` -. ( ( ph -> ps ) -> -. ( ps -> ph ) ) ` but we don't yet have a
     ...
     previously proved theorem ~ bijust . Note that from Metamath's point of
     ...
     definition labels with "df-" instead of "ax-".  (This prefixing is an
     informal convention that means nothing to the Metamath proof verifier;
     it is just for human readability.)  See ~ bii and ~ bi for theorems
  ...
  $( This proof of ~ bii , discovered by Gregory Bush on 8-Mar-04, has
     ...
     how intermediate steps can "blow up" in size even in short proofs.  If
     there were an obfuscated code contest for proofs, this might be a
     winner. $)
  ...
  $( Double negation.  Theorem *4.13 of [WhiteheadRussell] p. 116. $)
  pm4.13 $p |- ( ph <-> -. -. ph ) $=
  ...
  $( Distributive law for implication.  Theorem *5.41 of
     [WhiteheadRussell] p. 125. $)
  pm5.41 $p |- ( ( ph -> ( ps -> ch ) ) <->
               ( ( ph -> ps ) -> ( ph -> ch ) ) ) $=
...
$)
  ...
  $( Logical 'or' expressed in terms of implication only. $)
  dfor2 $p |- ( ( ph \/ ps ) <-> ( ( ph -> ps ) -> ps ) ) $=
    ( wo wn wi df-or pm2.61 com12 pm2.21 syl4 impbi bitr ) ABCADZBEZABEZBEZABFN
    PONBABGHMOBABIJKL $.
    $( [20-Aug-04] $) $( [12-Aug-04] $)
  ...
  imor $p |- ( ( ph -> ps ) <-> ( -. ph \/ ps ) ) $=
    ( wi wn wo pm4.13 birim df-or bitr4 ) ABCADZDZBCJBEAKBAFGJBHI $.
    $( [5-Aug-93] $)

  $( Express implication in terms of conjunction.  Theorem 3.4(27) of [Stoll]
     p. 176. $)
  iman $p |- ( ( ph -> ps ) <-> -. ( ph /\ -. ps ) ) $=
    ( wi wn wa pm4.13 bilim df-an bicon2i bitr ) ABCABDZDZCZAKEZDBLABFGNMAKHIJ
    $.
    $( [5-Aug-93] $)
  ...
  $( Idempotent law for disjunction.  Theorem *4.25 of [WhiteheadRussell]
     p. 117. $)
  oridm $p |- ( ( ph \/ ph ) <-> ph ) $=
    ( wo wn wi df-or ax-1 pm2.18 impbi bitr4 ) AABACZADZAAAEAKAJFAGHI $.
    $( [5-Aug-93] $)
  ...
  ${
    ...
    $( Inference adding a left disjunct to both sides of a logical
       equivalence. $)
    bilor $p |- ( ( ch \/ ph ) <-> ( ch \/ ps ) ) $=
      ( wn wi wo bilim df-or 3bitr4 ) CEZAFKBFCAGCBGABKDHCAICBIJ $.
      $( [5-Aug-93] $)

    $( Inference adding a right disjunct to both sides of a logical
       equivalence. $)
    biror $p |- ( ( ph \/ ch ) <-> ( ps \/ ch ) ) $=
      ( wo orcom bilor 3bitr ) ACECAECBEBCEACFABCDGCBFH $.
      $( [5-Aug-93] $)
  ...
  ${
    ...
    bi2or $p |- ( ( ph \/ ch ) <-> ( ps \/ th ) ) $=
      ( wo bilor biror bitr ) ACGADGBDGCDAFHABDEIJ $.
      $( [5-Aug-93] $)
  $}

  $( A rearrangement of disjuncts. $)
  or12 $p |- ( ( ph \/ ( ps \/ ch ) ) <-> ( ps \/ ( ph \/ ch ) ) ) $=
    ( wn wo wi bi2.04 df-or bilim 3bitr4r 3bitr4 ) ADZBCEZFZBDZACEZFZAMEBPEOLCF
    ZFLOCFZFQNOLCGPROACHIMSLBCHIJAMHBPHK $.
    $( [5-Aug-93] $)

  $( Associative law for disjunction.  Theorem *4.33 of [WhiteheadRussell]
     p. 118. $)
  orass $p |- ( ( ( ph \/ ps ) \/ ch ) <-> ( ph \/ ( ps \/ ch ) ) ) $=
    ( wo or12 orcom bilor 3bitr4 ) CABDZDACBDZDICDABCDZDCABEICFKJABCFGH $.
    $( [5-Aug-93] $)

  $( A rearrangement of disjuncts. $)
  or23 $p |- ( ( ( ph \/ ps ) \/ ch ) <-> ( ( ph \/ ch ) \/ ps ) ) $=
    ( wo orcom bilor orass 3bitr4 ) ABCDZDACBDZDABDCDACDBDIJABCEFABCGACBGH $.
    $( [18-Oct-95] $)

  $( Rearrangement of 4 disjuncts. $)
  or4 $p |- ( ( ( ph \/ ps ) \/ ( ch \/ th ) ) <->
                ( ( ph \/ ch ) \/ ( ps \/ th ) ) ) $=
    ( wo or12 bilor orass 3bitr4 ) ABCDEZEZEACBDEZEZEABEJEACELEKMABCDFGABJHACLH
    I $.
    $( [12-Aug-94] $)
  ...
  orordi $p |- ( ( ph \/ ( ps \/ ch ) ) <->
               ( ( ph \/ ps ) \/ ( ph \/ ch ) ) ) $=
    ( wo oridm biror or4 bitr3 ) ABCDZDAADZIDABDACDDJAIAEFAABCGH $.
    $( [25-Feb-95] $)

  $( Distribution of disjunction over disjunction. $)
  orordir $p |- ( ( ( ph \/ ps ) \/ ch ) <->
               ( ( ph \/ ch ) \/ ( ps \/ ch ) ) ) $=
    ( wo oridm bilor or4 bitr3 ) ABDZCDICCDZDACDBCDDJCICEFABCCGH $.
    $( [25-Feb-95] $)
  ...
  orc $p |- ( ph -> ( ph \/ ps ) ) $=
    ( wn pm2.21 com12 orrd ) AABACABABDEF $.
    $( [30-Aug-93] $)
  ...
  oran $p |- ( ( ph \/ ps ) <-> -. ( -. ph /\ -. ps ) ) $=
    ( wo wn wa pm4.13 ioran bineg bitr ) ABCZJDZDADBDEZDJFKLABGHI $.
    $( [5-Aug-93] $)

  $( Elimination of a conjunct.  Theorem *3.26 of [WhiteheadRussell] p. 112. $)
  pm3.26 $p |- ( ( ph /\ ps ) -> ph ) $=
  ...
  $( Elimination of a conjunct.  Theorem *3.27 of [WhiteheadRussell] p. 112. $)
  pm3.27 $p |- ( ( ph /\ ps ) -> ps ) $=
  ...
  ${
    ...
    $( Conjoin antecedents and consequents of two premises. $)
    im2or $p |- ( ( ph \/ ch ) -> ( ps \/ th ) ) $=
      ( wn wa wo con3i im2an oran 3imtr4 ) AGZCGZHZGBGZDGZHZGACIBDISPQNROABEJCD
      FJKJACLBDLM $.
      $( [6-Jun-94] $)
  $}
  ...
  impexp $p |- ( ( ( ph /\ ps ) -> ch ) <-> ( ph -> ( ps -> ch ) ) ) $=
    ( wa wi wn df-an birim expt impt impbi bitr ) ABDZCEABFEFZCEZABCEEZMNCABGHO
    PABCIABCJKL $.
    $( [5-Aug-93] $)
  ...
  $( Conjunctive detachment.  Theorem *3.35 of [WhiteheadRussell] p. 112,
     which they curiously call "Syll" (syllogism). $)
  ...
  ${
    ...
    jaod $p |- ( ph -> ( ( ps \/ th ) -> ch ) ) $=
      ( wi wo jao syl13 ) BCGDCGBDHCGABCDIEFJ $.
      $( [18-Aug-94] $)
  $}
  ...
  anass $p |- ( ( ( ph /\ ps ) /\ ch ) <-> ( ph /\ ( ps /\ ch ) ) ) $=
    ( wa wn wi impexp imnan bilim bitr bineg df-an 3bitr4 ) ABDZCEZFZEABCDZEZFZ
    ENCDAQDPSPABOFZFSABOGTRABCHIJKNCLAQLM $.
    $( [5-Aug-93] $)
  ...
  ${
    ...
    syland $p |- ( ph -> ( ( ta /\ ch ) -> th ) ) $=
      ( wa wi com12 sylan ) ECHADBCADIEABCHDFJGKJ $.
      $( [2-May-96] $)
  $}
  ...
  ${
    ...
    sylan2d $p |- ( ph -> ( ( ps /\ ta ) -> th ) ) $=
      ( wa wi com12 sylan2 ) BEHADBCADIEABCHDFJGKJ $.
      $( [1-Aug-94] $)
  $}
  ...
  ${
    sylan13.1 $e |- ( ( ph /\ ps ) -> ch ) $.
    sylan13.2 $e |- ( th -> ph ) $.
    sylan13.3 $e |- ( th -> ps ) $.
    $( A syllogism inference. $)
    sylan13 $p |- ( th -> ch ) $=
      ( exp syl13 ) ABCDABCEHFGI $.
      $( [3-Oct-99] $)
  $}

  ${
    sylan13b.1 $e |- ( ( ph /\ ps ) -> ch ) $.
    sylan13b.2 $e |- ( th <-> ph ) $.
    sylan13b.3 $e |- ( th <-> ps ) $.
    $( A syllogism inference. $)
    sylan13b $p |- ( th -> ch ) $=
  ...
  ${
    ...
    bilan $p |- ( ( ch /\ ph ) <-> ( ch /\ ps ) ) $=
      ( wa biimp imlan biimpr impbi ) CAECBEABCABDFGBACABDHGI $.
      $( [5-Aug-93] $)

    $( Introduce a right conjunct to both sides of a logical equivalence. $)
    biran $p |- ( ( ph /\ ch ) <-> ( ps /\ ch ) ) $=
      ( wa ancom bilan 3bitr ) ACECAECBEBCEACFABCDGCBFH $.
      $( [5-Aug-93] $)
  $}
  ...
  ${
    ...
    bi2an $p |- ( ( ph /\ ch ) <-> ( ps /\ th ) ) $=
      ( wa biran bilan bitr ) ACGBCGBDGABCEHCDBFIJ $.
      $( [5-Aug-93] $)
  $}

  $( A rearrangement of conjuncts. $)
  an12 $p |- ( ( ph /\ ( ps /\ ch ) ) <-> ( ps /\ ( ph /\ ch ) ) ) $=
    ( wa ancom biran anass 3bitr3 ) ABDZCDBADZCDABCDDBACDDIJCABEFABCGBACGH $.
    $( [12-Mar-95] $)

  $( A rearrangement of conjuncts. $)
  an23 $p |- ( ( ( ph /\ ps ) /\ ch ) <-> ( ( ph /\ ch ) /\ ps ) ) $=
    ( wa ancom bilan anass 3bitr4 ) ABCDZDACBDZDABDCDACDBDIJABCEFABCGACBGH $.
    $( [12-Mar-95] $)
  ...
  an4 $p |- ( ( ( ph /\ ps ) /\ ( ch /\ th ) ) <->
              ( ( ph /\ ch ) /\ ( ps /\ th ) ) ) $=
    ( wa an12 bilan anass 3bitr4 ) ABCDEZEZEACBDEZEZEABEJEACELEKMABCDFGABJHACLH
    I $.
    $( [10-Jul-94] $)

  $( Rearrangement of 4 conjuncts. $)
  an41r3 $p |- ( ( ( ph /\ ps ) /\ ( ch /\ th ) ) <->
                 ( ( ph /\ ch ) /\ ( th /\ ps ) ) ) $=
    ( wa an4 ancom bilan bitr ) ABECDEEACEZBDEZEJDBEZEABCDFKLJBDGHI $.
    $( [7-Feb-96] $)
  ...
  ${
    ...
    $( Inference rearranging 4 conjuncts in antecedent. $)
    an41r3s $p |- ( ( ( ph /\ ch ) /\ ( th /\ ps ) ) -> ta ) $=
      ( wa an41r3 sylbir ) ACGDBGGABGCDGGEABCDHFI $.
      $( [10-Aug-95] $)
  $}
  ...
  anandi $p |- ( ( ph /\ ( ps /\ ch ) ) <->
               ( ( ph /\ ps ) /\ ( ph /\ ch ) ) ) $=
    ( wa anidm biran an4 bitr3 ) ABCDZDAADZIDABDACDDJAIAEFAABCGH $.
    $( [14-Aug-95] $)

  $( Distribution of conjunction over conjunction. $)
  anandir $p |- ( ( ( ph /\ ps ) /\ ch ) <->
               ( ( ph /\ ch ) /\ ( ps /\ ch ) ) ) $=
    ( wa anidm bilan an4 bitr3 ) ABDZCDICCDZDACDBCDDJCICEFABCCGH $.
    $( [24-Aug-95] $)
  ...
  pm4.11 $p |- ( ( ph <-> ps ) <-> ( -. ph <-> -. ps ) ) $=
    ( wb wn wi wa pm4.1 bi2an bi 3bitr4 bicom bitr ) ABCZBDZADZCZONCABEZBAEZFNO
    EZONEZFMPQSRTABGBAGHABINOIJNOKL $.
    $( [21-May-94] $)
  ...
  bicon2 $p |- ( ( ph <-> -. ps ) <-> ( ps <-> -. ph ) ) $=
    ( wn wi wa wb bi2.03 bi2.15 bi2an bi 3bitr4 ) ABCZDZLADZEBACZDZOBDZEALFBOFM
    PNQABGBAHIALJBOJK $.
    $( [15-Apr-95] $)
  ...
  ${
    ...
    3imtr3g $p |- ( ph -> ( th -> ta ) ) $=
      ( wa imp bilan 3imtr3 exp ) ADEABICADIEABCFJBDAGKHLM $.
      $( [20-May-96] $)
  $}
  ...
  ${
    ...
    im2and $p |- ( ph -> ( ( ps /\ th ) -> ( ch /\ ta ) ) ) $=
      ( wi wa prth sylan13 ) BCHDEHBDICEIHABCDEJFGK $.
      $( [3-Apr-94] $)
  $}
  ...
  ${
    ...
    imland $p |- ( ph -> ( ( th /\ ps ) -> ( th /\ ch ) ) ) $=
      ( idd im2and ) ADDBCADFEG $.
      $( [5-Aug-93] $)
  $}
  ...
  ${
    ...
    imrand $p |- ( ph -> ( ( ps /\ th ) -> ( ch /\ th ) ) ) $=
      ( idd im2and ) ABCDDEADFG $.
      $( [3-Apr-94] $)
  $}
  ...
  ${
    ...
    im2anan9 $p |- ( ( ph /\ th ) -> ( ( ps /\ ta ) -> ( ch /\ et ) ) ) $=
      ( wa wi adantr adantl im2and ) ADIBCEFABCJDGKDEFJAHLM $.
      $( [29-Feb-96] $)

    $( Deduction joining nested implications to form implication of
       conjunctions. $)
    im2anan9r $p |- ( ( th /\ ph ) -> ( ( ps /\ ta ) -> ( ch /\ et ) ) ) $=
      ( wa wi adantl adantr im2and ) DAIBCEFABCJDGKDEFJAHLM $.
      $( [29-Feb-96] $)
  ...
  ${
    ...
    im2ord $p |- ( ph -> ( ( ps \/ th ) -> ( ch \/ ta ) ) ) $=
      ( wi wo pm3.48 sylan13 ) BCHDEHBDICEIHABCDEJFGK $.
      $( [10-May-94] $)
  $}
  ...
  ${
    imlord.1 $e |- ( ph -> ( ps -> ch ) ) $.
    $( Disjoin antecedents and consequents in a deduction. $)
    imlord $p |- ( ph -> ( ( th \/ ps ) -> ( th \/ ch ) ) ) $=
      ( idd im2ord ) ADDBCADFEG $.
      $( [23-Apr-95] $)
  $}
  ...
  ${
    imrord.1 $e |- ( ph -> ( ps -> ch ) ) $.
    $( Disjoin antecedents and consequents in a deduction. $)
    imrord $p |- ( ph -> ( ( ps \/ th ) -> ( ch \/ th ) ) ) $=
      ( idd im2ord ) ABCDDEADFG $.
      $( [23-Apr-95] $)
  $}
  ...
  pm5.74 $p |- ( ( ph -> ( ps <-> ch ) ) <->
               ( ( ph -> ps ) <-> ( ph -> ch ) ) ) $=
    ( wb wi bi1 syl3 a2d bi2 impbid wa pm2.86d im2and anidm bicomi bi 3imtr4g
    impbi ) ABCDZEZABEZACEZDZTUAUBTABCSBCEZABCFGHTACBSCBEZABCIGHJUCAAKZUDUEKASU
    CAUDAUEUCABCUAUBFLUCACBUAUBILMUFAANOBCPQR $.
    $( [1-Aug-94] $)
  ...
  ordi $p |- ( ( ph \/ ( ps /\ ch ) ) <-> ( ( ph \/ ps ) /\ ( ph \/ ch ) ) ) $=
    ( wa wo pm3.26 imlor pm3.27 jca wn wi df-or pm3.43i 3imtr4g sylbi imp
  ...
  ordir $p |- ( ( ( ph /\ ps ) \/ ch ) <->
              ( ( ph \/ ch ) /\ ( ps \/ ch ) ) ) $=
    ( wa wo ordi orcom bi2an 3bitr4 ) CABDZECAEZCBEZDJCEACEZBCEZDCABFJCGMKNLACG
    BCGHI $.
    $( [12-Aug-94] $)
  ...
  jcab $p |- ( ( ph -> ( ps /\ ch ) ) <->
                 ( ( ph -> ps ) /\ ( ph -> ch ) ) ) $=
    ( wn wa wo wi ordi imor bi2an 3bitr4 ) ADZBCEZFLBFZLCFZEAMGABGZACGZELBCHAMI
    PNQOABIACIJK $.
    $( [3-Apr-94] $)
  ...
  andi $p |- ( ( ph /\ ( ps \/ ch ) ) <-> ( ( ph /\ ps ) \/ ( ph /\ ch ) ) ) $=
    ( wn wo wa ordi ioran bilor ianor bi2an 3bitr4 bineg anor oran ) ADZBCEZDZE
    ZDABFZDZACFZDZFZDAQFTUBESUDPBDZCDZFZEPUEEZPUFEZFSUDPUEUFGRUGPBCHIUAUHUCUIAB
    JACJKLMAQNTUBOL $.
    $( [5-Aug-93] $)
  ...
  andir $p |- ( ( ( ph \/ ps ) /\ ch ) <->
              ( ( ph /\ ch ) \/ ( ps /\ ch ) ) ) $=
    ( wo wa andi ancom bi2or 3bitr4 ) CABDZECAEZCBEZDJCEACEZBCEZDCABFJCGMKNLACG
    BCGHI $.
    $( [12-Aug-94] $)
  ...
  orddi $p |- ( ( ( ph /\ ps ) \/ ( ch /\ th ) ) <->
              ( ( ( ph \/ ch ) /\ ( ph \/ th ) ) /\
              ( ( ps \/ ch ) /\ ( ps \/ th ) ) ) ) $=
    ( wa wo ordir ordi bi2an bitr ) ABECDEZFAKFZBKFZEACFADFEZBCFBDFEZEABKGLNMOA
    CDHBCDHIJ $.
    $( [12-Aug-94] $)
  ...
  anddi $p |- ( ( ( ph \/ ps ) /\ ( ch \/ th ) ) <->
              ( ( ( ph /\ ch ) \/ ( ph /\ th ) ) \/
              ( ( ps /\ ch ) \/ ( ps /\ th ) ) ) ) $=
    ( wo wa andir andi bi2or bitr ) ABECDEZFAKFZBKFZEACFADFEZBCFBDFEZEABKGLNMOA
    CDHBCDHIJ $.
    $( [12-Aug-94] $)
  ...
  ${
    ...
    bilbi $p |- ( ( ch <-> ph ) <-> ( ch <-> ps ) ) $=
      ( wb wi wa bi birim bilan bilim biran bitr4 3bitr ) CAECAFZACFZGOBCFZGZCB
      EZCAHPQOABCDIJRCBFZQGSOTQABCDKLCBHMN $.
      $( [5-Aug-93] $)

    $( Inference adding a biconditional to the right in an equivalence. $)
    birbi $p |- ( ( ph <-> ch ) <-> ( ps <-> ch ) ) $=
      ( wb bicom bilbi 3bitr ) ACECAECBEBCEACFABCDGCBFH $.
      $( [5-Aug-93] $)
  ...
  ${
    ...
    bi2bi $p |- ( ( ph <-> ch ) <-> ( ps <-> th ) ) $=
      ( wb bilbi birbi bitr ) ACGADGBDGCDAFHABDEIJ $.
      $( [5-Aug-93] $)
  $}
  ...
  ${
    ...
    $( Deduction adding an antecedent to both sides of a logical
       equivalence. $)
    bilimd $p |- ( ph -> ( ( th -> ps ) <-> ( th -> ch ) ) ) $=
      ( wb a1d pm5.74d ) ADBCABCFDEGH $.
      $( [5-Aug-93] $)

    $( Deduction adding a consequent to both sides of a logical equivalence. $)
    birimd $p |- ( ph -> ( ( ps -> th ) <-> ( ch -> th ) ) ) $=
      ( wn wi binegd bilimd pm4.1 3bitr4g ) ADFZBFZGLCFZGBDGCDGAMNLABCEHIBDJCDJ
      K $.
      $( [5-Aug-93] $)

    $( Deduction adding a left disjunct to both sides of a logical
       equivalence. $)
    bilord $p |- ( ph -> ( ( th \/ ps ) <-> ( th \/ ch ) ) ) $=
      ( wn wi wo bilimd df-or 3bitr4g ) ADFZBGLCGDBHDCHABCLEIDBJDCJK $.
      $( [5-Aug-93] $)

    $( Deduction adding a right disjunct to both sides of a logical
       equivalence. $)
    birord $p |- ( ph -> ( ( ps \/ th ) <-> ( ch \/ th ) ) ) $=
      ( wo bilord orcom 3bitr4g ) ADBFDCFBDFCDFABCDEGBDHCDHI $.
      $( [5-Aug-93] $)

    $( Deduction adding a left conjunct to both sides of a logical
       equivalence. $)
    biland $p |- ( ph -> ( ( th /\ ps ) <-> ( th /\ ch ) ) ) $=
      ( wa biimpd imland biimprd impbid ) ADBFDCFABCDABCEGHACBDABCEIHJ $.
      $( [5-Aug-93] $)

    $( Deduction adding a right conjunct to both sides of a logical
       equivalence. $)
    birand $p |- ( ph -> ( ( ps /\ th ) <-> ( ch /\ th ) ) ) $=
      ( wa biland ancom 3bitr4g ) ADBFDCFBDFCDFABCDEGBDHCDHI $.
      $( [5-Aug-93] $)

    $( Deduction adding a biconditional to the left in an equivalence. $)
    bilbid $p |- ( ph -> ( ( th <-> ps ) <-> ( th <-> ch ) ) ) $=
      ( wi wa wb bilimd birand birimd biland bitrd bi 3bitr4g ) ADBFZBDFZGZDCFZ
      CDFZGZDBHDCHARSQGUAAPSQABCDEIJAQTSABCDEKLMDBNDCNO $.
      $( [5-Aug-93] $)

    $( Deduction adding a biconditional to the right in an equivalence. $)
    birbid $p |- ( ph -> ( ( ps <-> th ) <-> ( ch <-> th ) ) ) $=
      ( wb bilbid bicom 3bitr4g ) ADBFDCFBDFCDFABCDEGBDHCDHI $.
      $( [5-Aug-93] $)
  ...
  ${
    ...
    $( Deduction joining two equivalences to form equivalence of
       implications. $)
    bi2imd $p |- ( ph -> ( ( ps -> th ) <-> ( ch -> ta ) ) ) $=
      ( wi birimd bilimd bitrd ) ABDHCDHCEHABCDFIADECGJK $.
      $( [5-Aug-93] $)

    $( Deduction joining two equivalences to form equivalence of
       disjunctions. $)
    bi2ord $p |- ( ph -> ( ( ps \/ th ) <-> ( ch \/ ta ) ) ) $=
      ( wo birord bilord bitrd ) ABDHCDHCEHABCDFIADECGJK $.
      $( [5-Aug-93] $)

    $( Deduction joining two equivalences to form equivalence of
       conjunctions. $)
    bi2and $p |- ( ph -> ( ( ps /\ th ) <-> ( ch /\ ta ) ) ) $=
      ( wa birand biland bitrd ) ABDHCDHCEHABCDFIADECGJK $.
      $( [5-Aug-93] $)

    $( Deduction joining two equivalences to form equivalence of
       biconditionals. $)
    bi2bid $p |- ( ph -> ( ( ps <-> th ) <-> ( ch <-> ta ) ) ) $=
      ( wb birbid bilbid bitrd ) ABDHCDHCEHABCDFIADECGJK $.
      $( [5-Aug-93] $)
  ...
  ${
    ...
    bi2anan9 $p |- ( ( ph /\ th ) -> ( ( ps /\ ta ) <-> ( ch /\ et ) ) ) $=
      ( wa birand biland sylan9bb ) ABEICEIDCFIABCEGJDEFCHKL $.
      $( [31-Jul-95] $)
    ...
    bi2bian9 $p |- ( ( ph /\ th ) -> ( ( ps <-> ta ) <-> ( ch <-> et ) ) ) $=
      ( wa wb adantr adantl bi2bid ) ADIBCEFABCJDGKDEFJAHLM $.
      $( [14-May-04] $) $( [12-May-04] $)
  $}
  ...
  pm4.71r $p |- ( ( ph -> ps ) <-> ( ph <-> ( ps /\ ph ) ) ) $=
    ( wi wa wb pm4.71 ancom bilbi bitr ) ABCAABDZEABADZEABFJKAABGHI $.
    $( [25-Jul-99] $)
  ...
  pm4.72 $p |- ( ( ph -> ps ) <-> ( ps <-> ( ph \/ ps ) ) ) $=
    ( wi wo wb olc a1i wn pm2.61 df-or syl5ib impbid bi2 orc syl5 impbi ) ABCZB
    ABDZEZQBRBRCQBAFGQAHBCBRABIABJKLSRBABRMABNOP $.
    $( [30-Aug-93] $)
  ...
  pm5.32 $p |- ( ( ph -> ( ps <-> ch ) ) <->
               ( ( ph /\ ps ) <-> ( ph /\ ch ) ) ) $=
    ( wb wi wn wa pm4.11 bilim pm5.74 3bitr df-an bi2bi bitr4 ) ABCDZEZABFZEZFZ
    ACFZEZFZDZABGZACGZDPAQTDZERUADUCOUFABCHIAQTJRUAHKUDSUEUBABLACLMN $.
    $( [1-Aug-94] $)
  ...
  oibabs $p |- ( ( ph <-> ps ) <-> ( ( ph \/ ps ) -> ( ph <-> ps ) ) ) $=
    ( wb wo wi ax-1 orc syl4 ibd olc ibib bicom bilim bitr sylibr impbid impbi
    ) ABCZABDZREZRSFTABTABASRABGHITBREZBAEZBSRBAJHUBBBACZEUABAKUCRBBALMNOPQ $.
    $( [6-Aug-95] $)
  ...
  pm5.18 $p |- ( ( ph <-> ps ) <-> -. ( ph <-> -. ps ) ) $=
    ( wb wn bicom wi wa pm2.61 pm2.65 con2 syl5 im2and bi syl5ib annim syl6ib
    com12 imnan sylib bineg sylibr wo pm2.21 nsyl4 adantl sylbir jca ax-1
    adantr pm3.4 jaoi ianor 3imtr4 sylbi impbi bitr bicon2i ) ABCBACZABDZCZDABE
     $.
    $( [28-Jun-02] $)
  ...
  $( An alternate definition of the biconditional. $)
  dfbi $p |- ( ( ph <-> ps ) <-> ( ( ph /\ ps ) \/ ( -. ph /\ -. ps ) ) ) $=
    ( wb wn wa wo pm5.18 wi imnan bi2.15 iman bitr bi2an bi ioran 3bitr4r
...
$)
  ...
  3ancoma $p |- ( ( ph /\ ps /\ ch ) <-> ( ps /\ ph /\ ch ) ) $=
    ( wa w3a ancom biran df-3an 3bitr4 ) ABDZCDBADZCDABCEBACEJKCABFGABCHBACHI
    $.
    $( [21-Apr-94] $)
  ...
  ${
    ...
    im3an $p |- ( ( ph /\ ch /\ ta ) -> ( ps /\ th /\ et ) ) $=
      ( wa w3a im2an df-3an 3imtr4 ) ACJZEJBDJZFJACEKBDFKOPEFABCDGHLILACEMBDFMN
      $.
      $( [8-Apr-94] $)
  $}
  ...
  ${
    ...
    bi3an $p |- ( ( ph /\ ch /\ ta ) <-> ( ps /\ th /\ et ) ) $=
      ( wa w3a bi2an df-3an 3bitr4 ) ACJZEJBDJZFJACEKBDFKOPEFABCDGHLILACEMBDFMN
      $.
      $( [21-Apr-94] $)

    $( Join antecedents and consequents with disjunction. $)
    bi3or $p |- ( ( ph \/ ch \/ ta ) <-> ( ps \/ th \/ et ) ) $=
      ( wo w3o bi2or df-3or 3bitr4 ) ACJZEJBDJZFJACEKBDFKOPEFABCDGHLILACEMBDFMN
      $.
      $( [17-May-94] $)
  $}
  ...
  ${
    ...
    ${
      ...
      syl3an $p |- ( ( ta /\ et /\ ze ) -> th ) $=
        ( w3a im3an syl ) EGHLABCLDEAGBHCIJKMFN $.
        $( [14-May-04] $) $( [13-May-04] $)
    $}
  ...
  ${
    ...
    $( Deduction joining 3 equivalences to form equivalence of
       disjunctions. $)
    bi3ord $p |- ( ph -> ( ( ps \/ th \/ et ) <-> ( ch \/ ta \/ ze ) ) ) $=
      ( wo w3o bi2ord df-3or 3bitr4g ) ABDKZFKCEKZGKBDFLCEGLAPQFGABCDEHIMJMBDFN
      CEGNO $.
      $( [20-Apr-94] $)

    $( Deduction joining 3 equivalences to form equivalence of
       conjunctions. $)
    bi3and $p |- ( ph -> ( ( ps /\ th /\ et ) <-> ( ch /\ ta /\ ze ) ) ) $=
      ( wa w3a bi2and df-3an 3bitr4g ) ABDKZFKCEKZGKBDFLCEGLAPQFGABCDEHIMJMBDFN
      CEGNO $.
      $( [22-Apr-94] $)
  ...
  ${
    ...
    $( Deduction joining 3 implications to form implication of
       disjunctions. $)
    im3ord $p |- ( ph -> ( ( ps \/ th \/ et ) -> ( ch \/ ta \/ ze ) ) ) $=
      ( wo w3o im2ord df-3or 3imtr4g ) ABDKZFKCEKZGKBDFLCEGLAPQFGABCDEHIMJMBDFN
      CEGNO $.
      $( [4-Apr-97] $)
  $}
  ...
  ${
    ...
    an6 $p |- ( ( ( ph /\ ps /\ ch ) /\ ( th /\ ta /\ et ) ) <->
              ( ( ph /\ th ) /\ ( ps /\ ta ) /\ ( ch /\ et ) ) ) $=
      ( w3a wa df-3an bi2an an4 biran 3bitr bitr4 ) ABCGZDEFGZHZADHZBEHZHZCFHZH
      ZRSUAGQABHZCHZDEHZFHZHUCUEHZUAHUBOUDPUFABCIDEFIJUCCUEFKUGTUAABDEKLMRSUAIN
      $.
      $( [13-Mar-95] $)
  $}
...
$)
  ...
  pm5.1 $p |- ( ( ph /\ ps ) -> ( ph <-> ps ) ) $=
    ( wb ibib pm5.74ri biimpa ) ABABCZABGABDEF $.
    $( [21-May-94] $)
  ...
  ${
    ...
    pm5.21ni $p |- ( -. ps -> ( ph <-> ch ) ) $=
      ( wn wb pm5.21 con3i sylan13 ) AFCFACGBFACHABDICBEIJ $.
      $( [16-Feb-96] $)
  $}
  ...
  elimant $p |- ( ( ( ph -> ps ) /\ ( ( ps -> ch ) -> ( ph -> th ) ) ) ->
                ( ph -> ( ch -> th ) ) ) $=
    ( wi wa wb id impac pm5.1 syl birimd biimpd exp com23 imp pm5.41 syl6ibr
  ...
  orcana $p |- ( ( ph -> ( ps \/ ch ) ) <-> ( ( ph /\ -. ps ) -> ch ) ) $=
    ( wo wi wn wa df-or bilim impexp bitr4 ) ABCDZEABFZCEZEAMGCELNABCHIAMCJK $.
    $( [8-Jun-94] $)

  $( Theorem to move a conjunct in and out of a negation. $)
  nan $p |- ( ( ph -> -. ( ps /\ ch ) ) <-> ( ( ph /\ ps ) -> -. ch ) ) $=
    ( wa wn wi impexp imnan bilim bitr2 ) ABDCEZFABKFZFABCDEZFABKGLMABCHIJ $.
    $( [9-Nov-03] $) $( [9-Nov-03] $)
  ...
  ${
    ...
    $( A deduction based on modus ponens. $)
    mpan2d $p |- ( ph -> ( ps -> th ) ) $=
      ( a1d exp3a mpdd ) ABCDACBEGABCDFHI $.
      $( [13-Dec-04] $) $( [12-Dec-04] $)
  $}
  ...
  ${
    ...
    biantrud $p |- ( ph -> ( ch <-> ( ch /\ ps ) ) ) $=
      ( wa imlan exp com12 wi pm3.26 a1i impbid ) ACCBEZCAMCAMABCDFGHMCIACBJKL
      $.
      $( [2-Aug-94] $)
  $}
  ...
  biantr $p |- ( ( ( ph <-> ps ) /\ ( ch <-> ps ) ) -> ( ph <-> ch ) ) $=
    ( wb id bilbid biimparc ) CBDZACDABDHCBAHEFG $.
    $( [18-Aug-93] $)
  ...
  ( ( ( ph /\ ch ) \/ ( ps /\ ch ) ) \/ ( ( ph /\ th ) \/ ( ps /\ th ) ) ) ) $=
    ( wo wa andi andir bi2or bitr ) ABEZCDEFKCFZKDFZEACFBCFEZADFBDFEZEKCDGLNMOA
    BCHABDHIJ $.
    $( [29-Jul-99] $)
  ...
  ${
    ...
    4cases $p |- ch $=
      ( wi exp wn pm2.61i ) BCABCHABCDIAJZBCFIKABJZCHAMCEILMCGIKK $.
      $( [25-Oct-03] $) $( [25-Oct-03] $)
  $}
  ...
  dedlem0a $p |- ( ph -> ( ps <-> ( ( ch -> ph ) -> ( ps /\ ph ) ) ) ) $=
    ( wi wa ax-1 a1i syl4 com12 impbid iba bilimd bitrd ) ABCADZBDZNBAEZDABOBOD
  ...
  dedlema $p |- ( ph -> ( ps <-> ( ( ps /\ ph ) \/ ( ch /\ -. ph ) ) ) ) $=
    ( wn wa wo wi orc a1i idd pm2.21 com12 adantld jaod impbid iba birord
    bitrd ) ABBCADZEZFZBAEZTFABUABUAGABTHIABBTABJASBCSABABKLMNOABUBTABPQR $.
    $( [26-Jun-02] $)
  ...
  con3th $p |- ( ( ph -> ps ) -> ( -. ps -> -. ph ) ) $=
    ( wi wn wa wo wb id binegd birimd bilimd elimh con3i dedt ) BAABCZBDZADZCBO
  ...
  consensus $p |- ( ( ( ( ph /\ ps ) \/ ( -. ph /\ ch ) ) \/ ( ps /\ ch ) ) <->
    ...
    bi2or sylib jaoi orc impbi ) ABDZAEZCDZFZBCDZFUDUDUDUEUDGUEBADZCUBDZFZUDAUE
    UHHABUHCABUHABCIJKUBCUHBUBCUHABCLJMNUFUAUGUCBAOCUBOPQRUDUEST $.
    $( [16-May-03] $)
  ...
  ${
    ...
    prlem1 $p |- ( ph -> ( ps ->
                  ( ( ( ps /\ ch ) \/ ( th /\ ta ) ) -> et ) ) ) $=
      ( wa wo wi biimprcd adantl a1d com23 wn pm2.21 com12 syl5 adantr jaoi
      com3l ) BCIZDEIZJABFUCABFKZKUDUCBAFUCAFKZBCUFBAFCGLMNOUDUEADUEEDDPZFBUGDF
      DFQRHSTNUAUB $.
      $( [18-Oct-95] $)
  $}
  ...
  prlem2 $p |- ( ( ( ph /\ ps ) \/ ( ch /\ th ) ) <->
               ( ( ph \/ ch ) /\ ( ( ph /\ ps ) \/ ( ch /\ th ) ) ) ) $=
    ( wa wo oel biran anass bitr orcom bi2or andi bitr4 ) ABEZCDEZFZACFZOEZRPEZ
    FRQEOSPTORAEZBESAUABACGHRABIJPRCEZDETCUBDCCAFZCEUBCAGUCRCCAKHJHRCDIJLROPMN
    $.
    $( [5-Aug-93] $)
  ...
  ${
    ...
    oplem1 $p |- ( ph -> ps ) $=
      ( wn wi wa ord bineg syl5ib jcad syl5bb biimpar syl6 pm2.18 syl ) ABJZBKB
      AUBCELBAUBCEABCFMADJEUBADEGMBDHNOPCBECDEBIHQRSBTUA $.
      $( [18-Oct-95] $)
  $}
  ...
  ( ( ( ph /\ ch ) /\ ( ps /\ th ) ) /\ ( ( ph /\ th ) /\ ( ps /\ ch ) ) ) ) $=
    ( wa anandir anandi bi2an ancom bilan an4 bitr 3bitr ) ABECDEZEANEZBNEZEACE
    ZADEZEZBCEZBDEZEZEZQUAERTEEZABNFOSPUBACDGBCDGHUCSUATEZEUDUBUESTUAIJQRUATKLM
    $.
    $( [4-Sep-95] $)
...
$)
  ...
  excomim $p |- ( E. x E. y ph -> E. y E. x ph ) $=
    ( wex 19.8a 19.22i hbe1 hbex 19.9r sylibr ) ACDZBDABDZCDZBDMKMBALCABEFFMBLB
    CABGHIJ $.
    $( [5-Aug-93] $)
  ...
  ${
    ...
    $( An axiom of standard predicate calculus.  Axiom 5 of [Mendelson] p. 59.
       ...
       would not (for us) be free in ` x = x ` since (by ~ eqid and ~ hbth ) we
       can prove ` ( x = x -> A. x x = x ) ` . $)
  ...
  ${
    ...
    19.27 $p |- ( A. x ( ph /\ ps ) <-> ( A. x ph /\ ps ) ) $=
      ( wa wal 19.26 19.3r bilan bitr4 ) ABECFACFZBCFZEKBEABCGBLKBCDHIJ $.
      $( [5-Aug-93] $)
  $}
  ...
  ${
    ...
    19.28 $p |- ( A. x ( ph /\ ps ) <-> ( ph /\ A. x ps ) ) $=
      ( wa wal 19.26 19.3r biran bitr4 ) ABECFACFZBCFZEALEABCGAKLACDHIJ $.
      $( [5-Aug-93] $)
  $}
  ...
  $( Theorem 19.35 of [Margaris] p. 90.  This theorem is useful for binding
  ...
  19.35 $p |- ( E. x ( ph -> ps ) <-> ( A. x ph -> E. x ps ) ) $=
    ( wal wn wi wex wa 19.26 annim bial df-an 3bitr3 bicon2i df-ex bilim
  ...
  ${
    ...
    19.36 $p |- ( E. x ( ph -> ps ) <-> ( A. x ph -> ps ) ) $=
      ( wi wex wal 19.35 19.9r bilim bitr4 ) ABECFACGZBCFZELBEABCHBMLBCDIJK $.
      $( [5-Aug-93] $)
  $}
  ...
  ${
    ...
    19.37 $p |- ( E. x ( ph -> ps ) <-> ( ph -> E. x ps ) ) $=
      ( wi wex wal 19.35 19.3r birim bitr4 ) ABECFACGZBCFZEAMEABCHALMACDIJK $.
      $( [5-Aug-93] $)
  $}
  ...
  19.30 $p |- ( A. x ( ph \/ ps ) -> ( A. x ph \/ E. x ps ) ) $=
    ( wn wi wal wo wex 19.20 orcom df-or bitr bial df-ex bilor imor 3bitr4
  ...
  19.43 $p |- ( E. x ( ph \/ ps ) <-> ( E. x ph \/ E. x ps ) ) $=
    ( wo wn wal wex wa ioran bial 19.26 alnex bi2an 3bitr bineg df-ex oran
  ...
  ${
    ...
    19.44 $p |- ( E. x ( ph \/ ps ) <-> ( E. x ph \/ ps ) ) $=
      ( wo wex 19.43 19.9r bilor bitr4 ) ABECFACFZBCFZEKBEABCGBLKBCDHIJ $.
      $( [5-Aug-93] $)
  $}
  ...
  ${
    ...
    19.45 $p |- ( E. x ( ph \/ ps ) <-> ( ph \/ E. x ps ) ) $=
      ( wo wex 19.43 19.9r biror bitr4 ) ABECFACFZBCFZEALEABCGAKLACDHIJ $.
      $( [5-Aug-93] $)
  $}
  ...
  19.33b $p |- ( -. ( E. x ph /\ E. x ps ) ->
    ...
    ( wex wa wn wo wal wi ianor alnex bi2or bitr4 wb biorf 19.20i 19.15 syl
  ...
  19.34 $p |- ( ( A. x ph \/ E. x ps ) -> E. x ( ph \/ ps ) ) $=
    ( wal wex wo 19.2 imror 19.43 sylibr ) ACDZBCEZFACEZLFABFCEKMLACGHABCIJ $.
    $( [5-Aug-93] $)
  ...
  ${
    ...
    19.41 $p |- ( E. x ( ph /\ ps ) <-> ( E. x ph /\ ps ) ) $=
      ( wa wex wn wal df-ex wo hbne 19.31 ianor bial alnex biror bitr4 3bitr4
  ...
  ${
    ...
    hband $p |- ( ph -> ( ( ps /\ ch ) -> A. x ( ps /\ ch ) ) ) $=
      ( wa wal im2and 19.26 syl6ibr ) ABCGZBDHZCDHZGLDHABMCNEFIBCDJK $.
      $( [2-Jan-02] $)
  $}
  ...
  ${
    ...
    hbbid $p |- ( ph -> ( ( ps <-> ch ) -> A. x ( ps <-> ch ) ) ) $=
      ( wi wa wal wb hbimd im2and bi albi 3imtr4g ) ABCHZCBHZIQDJZRDJZIBCKZUADJ
      AQSRTABCDEFGLACBDEGFLMBCNBCDOP $.
      $( [1-Jan-02] $)
  $}
...
$)
  ...
  $( Axiom of Equality.  One of the 5 equality axioms of predicate calculus.
     ...
     later as ~ eqt ).  Axiom scheme C8' in [Megill] p. 448  (p. 16 of the
...
$)
  ...
  ${
    ...
    eq4ds $p |- ( -. A. y y = x -> ph ) $=
      ( weq wal eq4 nsyl4 con1i ) ACBECFZBCEBFJABCGDHI $.
      $( [2-Jan-02] $)
  $}
  ...
  eqs2 $p |- ( -. A. x x = y ->
    ...
    ( weq wal wn wi eq6 hbn1 ax-11 con1 syl6 com23 19.21ad ) BCDZBEFZOAFZGZBEZF
    ZOAGBBCBHRBIPOTAPOQSGTAGQBCJASKLMN $.
    $( [25-Apr-94] $)
  ...
  ${
    ...
    eqsex $p |- ( E. x ( x = y /\ ph ) <-> ps ) $=
      ( weq wn wi wex wal wa exnal df-an biex hbne binegd eqsal bicon2i 3bitr4
  ...
  ${
    ...
    del40 $p |- ( A. x x = y -> ( E. x ph -> E. y ps ) ) $=
      ( weq wal wn wex con3d del35 df-ex 3imtr4g ) CDFCGZAHZCGZHBHZDGZHACIBDINR
      PQOCDNABEJKJACLBDLM $.
      $( [5-Aug-93] $)
  $}
  ...
  ${
    ...
    del41 $p |- ( A. x x = y -> ( E. y ph -> E. x ps ) ) $=
      ( weq wal wn wex con3d del34 df-ex 3imtr4g ) CDFCGZAHZDGZHBHZCGZHADIBCINR
      PQOCDNABEJKJADLBCLM $.
      $( [5-Aug-93] $)
  $}
  ...
  ${
    ...
    del42 $p |- ( A. x x = y -> ( E. z ph -> E. z ps ) ) $=
      ( weq wal wn wex con3d del36 df-ex 3imtr4g ) CDGCHZAIZEHZIBIZEHZIAEJBEJOS
  ...
  ${
    ...
    cbvex $p |- ( E. x ph <-> E. y ps ) $=
      ( wn wal wex hbne weq binegd cbval bineg df-ex 3bitr4 ) AHZCIZHBHZDIZHACJ
      BDJSUARTCDADEKBCFKCDLABGMNOACPBDPQ $.
      $( [5-Aug-93] $)
  $}
  ...
  eqvin.l1 $p |- ( x = y -> E. z ( x = z /\ z = y ) ) $=
    ( weq wal wo wa wex wi a9e eqid jctl 19.22i ax-mp ax-8 a4s imrand del42
    mpi eqcom jctir ax-1 imland jaoi a1d wn ioran eq6 hban ax-12 imp anc2li
    eqcoms a4c1 sylbi pm2.61i ) CADZCEZCBDZCEZFZABDZACDZUSGZCHZIZVAVEVBURVEUTUR
    CCDZUSGZCHZVEUSCHVICBJUSVHCUSVGCKZLMNVHVDCACURVGVCUSUQVGVCICCACOPQRSUTVCVGG
    ZCHZVEUQCHVLCAJUQVKCUQVCVGCATVJUAMNVKVDCBCUTVGUSVCUSVGUSICUSVGUBPUCRSUDUEVA
    UFURUFZUTUFZGZVFURUTUGVBVDVOCAVMVNCCACUHCBCUHUIVMVNVBVBCEIABCUJUKVBVDIACVCV
    BUSACBOULUMUNUOUP $.
    $( [5-Aug-93] $)
...
$)
  ...
  $( Define proper substitution.  Remark 9.1 in [Megill] p. 447 (p. 15 of the
     ...
     ` ph ( x ) ` ".  For example, if the original ` ph ( x ) ` is ` x = y ` ,
     then ` ph ( y ) ` is ` y = y ` , from which we obtain that ` ph ( x ) `
     is ` x = x ` .  So what exactly does ` ph ( x ) ` mean?  Curry's notation
     solves this problem.
  ...
  del43 $p |- ( A. x x = y -> ( [ z / x ] ph -> [ z / y ] ph ) ) $=
    ( weq wal wi wa wex wsb ax-8 a4s eq4s syl4d imrand del40 im2and df-sb
    3imtr4g ) BCEZBFZBDEZAGZUBAHZBIZHCDEZAGZUFAHZCIZHABDJACDJUAUCUGUEUIUAUFUBAU
    FUBGZCBCBEUJCCBDKLMNUDUHBCUAUBUFATUBUFGBBCDKLOPQABDRACDRS $.
    $( [5-Aug-93] $)
  ...
  sbequ12r $p |- ( x = y -> ( [ x / y ] ph <-> ph ) ) $=
    ( weq wsb wb sbequ12 eqcomb bicom 3imtr4 ) CBDAACBEZFBCDKAFACBGBCHKAIJ $.
    $( [7-Oct-04] $) $( [6-Oct-04] $)
  ...
  sbid $p |- ( [ x / x ] ph <-> ph ) $=
    ( wsb weq wb eqid sbequ12 ax-mp bicomi ) AABBCZBBDAJEBFABBGHI $.
    $( [5-Aug-93] $)
  ...
  $( The specialization axiom of standard predicate calculus.  It states that
     ...
     specific case of ` y ` (properly) substituted for ` x ` .  Axiom 4 of
     [Mendelson] p. 59. $)
  ...
  ${
    sbf1OLD.1 $e |- ( ph -> A. x ph ) $.
    $( Substitution for a variable not free does not affect a wff. $)
    sbf1OLD $p |- ( ph <-> [ y / x ] ph ) $=
  ...
  ${
    ...
    sb6x $p |- ( [ y / x ] ph <-> A. x ( x = y -> ph ) ) $=
      ( wsb weq wi wal sbf1OLD ax-1 19.21ai sylbir sb2 impbi ) ABCEZBCFZAGZBHZO
      ARABCDIAQBDAPJKLABCMN $.
      $( [5-Aug-93] $)
  $}
  ...
  sbn1 $p |- ( [ y / x ] -. ph -> -. [ y / x ] ph ) $=
    ( weq wal wn wsb wi sbequ2 con3d syld a4s sb4 wa wex sb1 eqs3 sylib con2i
  ...
  ${
    ...
    sb5y $p |- ( [ y / x ] ph <-> E. x ( x = y /\ ph ) ) $=
      ( wsb weq wn wi wal wa wex hbne sb6y sbn bitr3 bicon2i eqs3 bitr4 ) ABCEZ
      BCFZAGZHBIZGTAJBKUBSUBUABCESGUABCACDLMABCNOPABCQR $.
      $( [5-Aug-93] $)
  $}
  ...
  sbor $p |- ( [ y / x ] ( ph \/ ps ) <-> ( [ y / x ] ph \/ [ y / x ] ps ) ) $=
    ( wn wi wsb wo sbim sbn birim bitr df-or bisb 3bitr4 ) AEZBFZCDGZACDGZEZBCD
    GZFZABHZCDGSUAHRPCDGZUAFUBPBCDIUDTUAACDJKLUCQCDABMNSUAMO $.
    $( [29-Sep-02] $)
  ...
  ${
    ...
    sb19.21 $p |- ( [ y / x ] ( ph -> ps ) <-> ( ph -> [ y / x ] ps ) ) $=
      ( wi wsb sbim sbf1OLD birim bitr4 ) ABFCDGACDGZBCDGZFAMFABCDHALMACDEIJK
      $.
      $( [5-Aug-93] $)
  $}
  ...
  sban $p |- ( [ y / x ] ( ph /\ ps ) <-> ( [ y / x ] ph /\ [ y / x ] ps ) ) $=
    ( wn wi wsb wa sbn sbim bilim bitr bineg df-an bisb 3bitr4 ) ABEZFZEZCDGZAC
    DGZBCDGZEZFZEZABHZCDGUAUBHTRCDGZEUERCDIUGUDUGUAQCDGZFUDAQCDJUHUCUABCDIKLMLU
    FSCDABNOUAUBNP $.
    $( [5-Aug-93] $)
  ...
  sbbi $p |- ( [ y / x ] ( ph <-> ps ) <-> ( [ y / x ] ph <-> [ y / x ] ps ) )
             $=
    ( wb wsb wi wa bi bisb sbim bi2an sban 3bitr4 bitr ) ABEZCDFABGZBAGZHZCDFZA
    CDFZBCDFZEZPSCDABIJQCDFZRCDFZHUAUBGZUBUAGZHTUCUDUFUEUGABCDKBACDKLQRCDMUAUBI
    NO $.
    $( [5-Aug-93] $)
  ...
  ${
    ...
    sblbis $p |- ( [ y / x ] ( ch <-> ph ) <-> ( [ y / x ] ch <-> ps ) ) $=
      ( wb wsb sbbi bilbi bitr ) CAGDEHCDEHZADEHZGLBGCADEIMBLFJK $.
      $( [19-Aug-93] $)
  $}
  ...
  ${
    ...
    sbrbis $p |- ( [ y / x ] ( ph <-> ch ) <-> ( ps <-> [ y / x ] ch ) ) $=
      ( wb wsb sbbi birbi bitr ) ACGDEHADEHZCDEHZGBMGACDEILBMFJK $.
      $( [18-Aug-93] $)
  $}
  ...
  ${
    ...
    sbrbif $p |- ( [ y / x ] ( ph <-> ch ) <-> ( ps <-> ch ) ) $=
      ( wb wsb sbrbis sbf1OLD bilbi bitr4 ) ACHDEIBCDEIZHBCHABCDEGJCNBCDEFKLM
      $.
      $( [18-Aug-93] $)
  $}
  ...
  sbequ5 $p |- ( A. x x = y <-> [ w / z ] A. x x = y ) $=
    ( weq wal eq5 sbf1OLD ) ABEAFCDABCGH $.
    $( [5-Aug-93] $)

  $( Substitution does not change a distinctor. $)
  sbequ6 $p |- ( -. A. x x = y <-> [ w / z ] -. A. x x = y ) $=
    ( weq wal wn eq6 sbf1OLD ) ABEAFGCDABCHI $.
    $( [5-Aug-93] $)

  ${
    sbt.1 $e |- ph $.
    $( A substitution into a theorem remains true.  (See ~ chv2 and ~ chv for
  ...
  sbequ8 $p |- ( [ y / x ] ph <-> [ y / x ] ( x = y -> ph ) ) $=
    ( wsb weq wi sbeq1 a1bi sbim bitr4 ) ABCDZBCEZBCDZKFLAFBCDMKBCGHLABCIJ $.
    $( [5-Aug-93] $)
  ...
  ${
    ...
    hbsb4 $p |- ( -. A. z z = y -> ( [ y / x ] ph -> A. z [ y / x ] ph ) ) $=
      ( weq wal wn wsb wi ax-8 a4s eq4s del35 con3d hbsb2 ax-10 syl9r syld wa
      eq5 ax-4 19.20i sbequ2 sbequ1 19.20ii syl5 3syl a1d sb4 eq6 hban ax-12
      imp a1i hbimd 19.20d sb2 a7s syl6 syl9 pm2.61i exp ) DBFDGZDCFZDGZHZABCIZ
      
      VSJVQEUOUPUQVTVIDBWAVHDABCURUCUSUTVAVBVCVB $.
      $( [5-Aug-93] $)
  $}
  ...
  hbsb4t $p |- ( A. x A. z ( ph -> A. z ph ) ->
    ...
    bi2imd a7s sylbi hbsb4 syl5bir ) AADEZFZDEBEZABCGZUIDEZFZUFBCGZULDEZFZDCHDE
    IUHAUFJZDEBEUKUNJZUGUOBDUGUGUFAFZKUOUQUGADLMAUFNOPUOUPDBUOBEZDEZUIULUJUMURU
    IULJDAUFBCQRZUSUIULDURDSUTTUAUBUCUFBCDADSUDUE $.
    $( [14-Apr-04] $) $( [7-Apr-04] $)
  ...
  ${
    ...
    $( Proof of ~ ddelimf without using ~ ax-11 .  This may be useful in a
    ...
    ddelimf2 $p |- ( -. A. x x = y -> ( ps -> A. x ps ) ) $=
      ...
      STUTULACUSUKCCECSCDCSTUSUKULULCJLEDCUAUBAACJLUTFUCUDUEUFUGABEDGHUHZUNBCVA
      UIUJ $.
      $( [12-Nov-02] $)
  $}
  ...
  ${
    ...
    $( Deduction form of ~ ddelimf .  This version may be useful if we want to
       avoid ~ ax-17 and use ~ ax-16 instead. $)
    ddelimdf $p |- ( ph -> ( -. A. x x = y -> ( ch -> A. x ch ) ) ) $=
      ( weq wal wn wi wa wsb 19.21ai 19.20i hbsb4t 3syl imp wb sbied adantr
      biald 3imtr3d exp ) ADELDMNZCCDMZOAUIPBFEQZUKDMZCUJAUIUKULOZAADMZFMBBDMOZ
      DMZFMUIUMOAUNFHGRUNUPFAUODISSBFEDTUAUBAUKCUCUIABCFEHJKUDZUEAULUJUCUIAUKCD
      GUQUFUEUGUH $.
      $( [15-Apr-04] $) $( [7-Apr-04] $)
  $}
  ...
  sbco $p |- ( [ y / x ] [ x / y ] ph <-> [ y / x ] ph ) $=
    ( wsb wb weq sbeq2 sbequ12 bicomd sbimi ax-mp sbbi mpbi ) ACBDZAEZBCDZNBCDA
    BCDECBFZBCDPBCGQOBCQANACBHIJKNABCLM $.
    $( [5-Aug-93] $)
  ...
  ${
    ...
    sbid2 $p |- ( [ y / x ] [ x / y ] ph <-> ph ) $=
      ( wsb sbco sbf1OLD bitr4 ) ACBEBCEABCEAABCFABCDGH $.
      $( [5-Aug-93] $)
  $}

  $( An idempotent law for substitution. $)
  sbidm $p |- ( [ y / x ] [ y / x ] ph <-> [ y / x ] ph ) $=
    ( weq wal wsb wb sbequ12 bicomd a4s wn eq6 hbsb2 wi pm4.2i a1i sbied
  ...
  ${
    ...
    sbco2 $p |- ( [ y / z ] [ z / x ] ph <-> [ y / x ] ph ) $=
      ( weq wal wsb wb sbequ sbid2 syl5bbr sbequ12 bitr3d a4s wn eq6 hbsb3
  ...
  sbcom $p |- ( [ y / z ] [ y / x ] ph <-> [ y / x ] [ y / z ] ph ) $=
    ...
    19.20i 19.21g 3syl biald adantrr eq4ds bi2.04 bial syl5bb alcom adantrl
  ...
  ${
    ...
    sb5f1 $p |- ( ph <-> A. x ( x = y -> [ x / y ] ph ) ) $=
      ( weq wsb wi wal sbequ1 eqcoms com12 19.21ai sb2 sbco sylib sbf1OLD
  ...
  sb9i $p |- ( A. x [ x / y ] ph -> A. y [ y / x ] ph ) $=
    ( weq wal wsb wi del43 del45 syld del35 wn hbsb2 19.20ii eq6s stdpc4 sbco
    sylib 19.20i a7s syl6 pm2.61i ) CBDCEZACBFZBEZABCFZCEZGUDUFCBUCUDABBFUFACBB
    HACBBIJKUCLZUEUDCEZBEZUGUEUJGCBBUHUDUIBACBMNOUDUGCBUEUFCUEUDBCFUFUDBCPABCQR
    STUAUB $.
    $( [5-Aug-93] $)
...
$)
  ...
  ${
    ...
    $( Theorem to add distinct quantifier to atomic formula.  (This theorem
       ...
       avoid reference to the redundant ~ ax-15 .) $)
  ...
  ${
    $d x y $.
    $( This is a version of ~ ax-11 when the variables are distinct.
       Axiom (C8) of [Monk2] p. 105. $)
    ax11a $p |- ( x = y -> ( ph -> A. x ( x = y -> ph ) ) ) $=
      ( weq wal wi ax-16 ax-1 syl5 a1d ax-11 pm2.61i ) BCDZBEZMAMAFZBEZFZFNQMNO
      PAOBCGAMHIJABCKL $.
      $( [5-Aug-93] $)
  $}
  ...
  ${
    ...
    a4w1 $p |- E. x ph $=
      ( wex weq biimprd a4w ax-mp ) BACGFBACDCDHABEIJK $.
      $( [19-Aug-93] $)
  $}
  ...
  ${
    ...
    eqvin.l2 $p |- ( E. z ( x = z /\ z = y ) -> x = y ) $=
      ( weq wa ax-17 eqt imp 19.23ai ) ACDZCBDZEABDZCLCFJKLACBGHI $.
      $( [5-Aug-93] $)

    $( A variable introduction law for equality.  Lemma 15 of [Monk2]
       p. 109. $)
    eqvin $p |- ( x = y <-> E. z ( x = z /\ z = y ) ) $=
      ( weq wa wex eqvin.l1 eqvin.l2 impbi ) ABDACDCBDECFABCGABCHI $.
      $( [5-Aug-93] $)
  $}
  ...
  ${
    ...
    a16g $p |- ( A. x x = y -> ( ph -> A. z ph ) ) $=
      ( weq wal wi eq5 wn ax9a ax-16 mt3i eqcom syl 19.21ai idd del35 syl9r
      mpcom ) DBEZDFZBCEBFZAADFZGUBTDBCDHUBBDEZTUBUDUDIZBFBDJUEBCKLBDMNOUBAABFU
      AUCABCKAADBUAAPQRS $.
      $( [5-Aug-93] $)

    $( A generalization of axiom ~ ax-16 . $)
    a16gb $p |- ( A. x x = y -> ( ph <-> A. z ph ) ) $=
      ( weq wal a16g wi ax-4 a1i impbid ) BCEBFZAADFZABCDGMAHLADIJK $.
      $( [5-Aug-93] $)
  $}
  ...
  ${
    ...
    bialdv.1 $e |- ( ph -> ( ps <-> ch ) ) $.
    $( Formula-building rule for universal quantifier (deduction rule). $)
    bialdv $p |- ( ph -> ( A. x ps <-> A. x ch ) ) $=
      ( ax-17 biald ) ABCDADFEG $.
      $( [5-Aug-93] $)

    $( Formula-building rule for existential quantifier (deduction rule). $)
    biexdv $p |- ( ph -> ( E. x ps <-> E. x ch ) ) $=
      ( ax-17 biexd ) ABCDADFEG $.
      $( [5-Aug-93] $)
  $}

  ${
    $d x ph $.  $d y ph $.
    bi2aldv.1 $e |- ( ph -> ( ps <-> ch ) ) $.
    $( Formula-building rule for 2 existential quantifiers (deduction rule). $)
    bi2aldv $p |- ( ph -> ( A. x A. y ps <-> A. x A. y ch ) ) $=
      ( wal bialdv ) ABEGCEGDABCEFHH $.
      $( [4-Mar-97] $)

    $( Formula-building rule for 2 existential quantifiers (deduction rule). $)
    bi2exdv $p |- ( ph -> ( E. x E. y ps <-> E. x E. y ch ) ) $=
      ( wex biexdv ) ABEGCEGDABCEFHH $.
      $( [1-May-95] $)
  $}

  ${
    $d x ph $.  $d y ph $.  $d z ph $.
    bi3exdv.1 $e |- ( ph -> ( ps <-> ch ) ) $.
    $( Formula-building rule for 3 existential quantifiers (deduction rule). $)
    bi3exdv $p |- ( ph -> ( E. x E. y E. z ps <-> E. x E. y E. z ch ) ) $=
      ( wex biexdv bi2exdv ) ABFHCFHDEABCFGIJ $.
      $( [1-May-95] $)
  $}

  ${
    $d x ph $.  $d y ph $.  $d z ph $.  $d w ph $.
    bi4exdv.1 $e |- ( ph -> ( ps <-> ch ) ) $.
    $( Formula-building rule for 4 existential quantifiers (deduction rule). $)
    bi4exdv $p |- ( ph ->
                     ( E. x E. y E. z E. w ps <-> E. x E. y E. z E. w ch ) ) $=
      ( wex bi2exdv ) ABGIFICGIFIDEABCFGHJJ $.
      $( [3-Aug-95] $)
  $}
  ...
  ${
    ...
    $( Special case of Theorem 19.21 of [Margaris] p. 90.  _Notational
       ...
       eliminating a hypothesis such as ` ( ph -> A. x ph ) ` in ~ 19.21
       via the use of distinct variable conditions combined with ~ ax-17 .
       Conversely, we sometimes suffix with "f" the label of a theorem
       introducing such a hypothesis to eliminate the need for the
       distinct variable condition; e.g. ~ euf derived from ~ df-eu .
       The "f" stands for "not free in" which is less restrictive than
       "does not occur in". $)
  ...
  ${
    $d x ph $.
    19.20dv.1 $e |- ( ph -> ( ps -> ch ) ) $.
    $( Deduction from Theorem 19.20 of [Margaris] p. 90. $)
    19.20dv $p |- ( ph -> ( A. x ps -> A. x ch ) ) $=
      ( ax-17 19.20d ) ABCDADFEG $.
      $( [3-Apr-94] $)

    $( Deduction from Theorem 19.22 of [Margaris] p. 90. $)
    19.22dv $p |- ( ph -> ( E. x ps -> E. x ch ) ) $=
      ( ax-17 19.22d ) ABCDADFEG $.
      $( [27-Apr-94] $)
  $}

  ${
    $d x ph $.  $d y ph $.
    19.20dvv.1 $e |- ( ph -> ( ps -> ch ) ) $.
    $( Deduction from Theorem 19.22 of [Margaris] p. 90. $)
    19.20dvv $p |- ( ph -> ( A. x A. y ps -> A. x A. y ch ) ) $=
      ( wal 19.20dv ) ABEGCEGDABCEFHH $.
      $( [8-May-04] $) $( [27-Apr-04] $)

    $( Deduction from Theorem 19.22 of [Margaris] p. 90. $)
    19.22dvv $p |- ( ph -> ( E. x E. y ps -> E. x E. y ch ) ) $=
      ( wex 19.22dv ) ABEGCEGDABCEFHH $.
      $( [3-Aug-95] $)
  $}
  ...
  ${
    ...
    19.23vv $p |- ( A. x A. y ( ph -> ps ) <-> ( E. x E. y ph -> ps ) ) $=
      ( wi wal wex 19.23v bial bitr ) ABEDFZCFADGZBEZCFLCGBEKMCABDHILBCHJ $.
      $( [23-Aug-04] $) $( [10-Aug-04] $)
  $}
  ...
  ${
    $d x y $.  $d x ps $.  $d y ph $.
    $( Special case of ~ 19.12 where its converse holds. $)
    19.12vv $p |- ( E. x A. y ( ph -> ps ) <-> A. y E. x ( ph -> ps ) ) $=
      ( wi wal wex 19.21v biex 19.36v bial bitr2 3bitr ) ABEZDFZCGABDFZEZCGACFZ
      PEZNCGZDFZOQCABDHIAPCJUARBEZDFSTUBDABCJKRBDHLM $.
      $( [18-Jul-01] $)
  $}
  ...
  ${
    ...
    19.41vv $p |- ( E. x E. y ( ph /\ ps ) <-> ( E. x E. y ph /\ ps ) ) $=
      ( wa wex 19.41v biex bitr ) ABEDFZCFADFZBEZCFKCFBEJLCABDGHKBCGI $.
      $( [30-Apr-95] $)
  $}
  ...
  ${
    ...
    19.41vvv $p |- ( E. x E. y E. z ( ph /\ ps ) <->
                     ( E. x E. y E. z ph /\ ps ) ) $=
      ( wa wex 19.41vv biex 19.41v bitr ) ABFEGDGZCGAEGDGZBFZCGMCGBFLNCABDEHIMB
      CJK $.
      $( [30-Apr-95] $)
  $}
  ...
  ${
    ...
    exdistr $p |- ( E. x E. y ( ph /\ ps ) <-> E. x ( ph /\ E. y ps ) ) $=
      ( wa wex 19.42v biex ) ABEDFABDFECABDGH $.
      $( [9-Mar-95] $)
  $}
  ...
  ${
    ...
    19.42vv $p |- ( E. x E. y ( ph /\ ps ) <-> ( ph /\ E. x E. y ps ) ) $=
      ( wa wex exdistr 19.42v bitr ) ABEDFCFABDFZECFAJCFEABCDGAJCHI $.
      $( [16-Mar-95] $)
  $}
  ...
  ${
    ...
    exdistr2 $p |- ( E. x E. y E. z ( ph /\ ps ) <->
                   E. x ( ph /\ E. y E. z ps ) ) $=
      ( wa wex 19.42vv biex ) ABFEGDGABEGDGFCABDEHI $.
      $( [17-Mar-95] $)
  $}
  ...
  ${
    ...
    3exdistr $p |- ( E. x E. y E. z ( ph /\ ps /\ ch ) <->
      ...
      ( w3a wex wa 3anass biex 19.42v bilan 3bitr bitr ) ABCGZFHZEHZABCFHIZEHIZ
      DRASIZEHTQUAEQABCIZIZFHAUBFHZIUAPUCFABCJKAUBFLUDSABCFLMNKASELOK $.
      $( [9-Mar-95] $)
  $}
  ...
  ${
    ...
    4exdistr $p |- ( E. x E. y E. z E. w ( ( ph /\ ps ) /\ ( ch /\ th ) ) <->
      ...
      ( wa wex anass biex 19.42v bilan 3bitr bitr ) ABICDIZIZHJZGJZFJZABCDHJIZG
      JIZFJIZEUAAUCIZFJUDTUEFTABUBIZIZGJAUFGJZIUESUGGSABQIZIZHJZUGRUJHABQKLUKAU
      IHJZIABQHJZIZIUGAUIHMULUNABQHMNUNUFAUMUBBCDHMNNOPLAUFGMUHUCABUBGMNOLAUCFM
      PL $.
      $( [9-Mar-95] $)
  $}
  ...
  ${
    ...
    cbval2 $p |- ( A. x A. y ph <-> A. z A. w ps ) $=
      ( wal hbal weq wb wi wa ax-17 hban exp com12 pm5.32d cbval 19.28 3bitr3
      pm5.32 mpbir ) ADLZBFLZCEAEDGMBCFIMCENZUHUIOPUJUHQZUJUIQZOUJAQZDLUJBQZFLU
      KULUMUNDFUJAFUJFRZHSUJBDUJDRZJSDFNZUJABUJUQABOZUJUQURKTUAUBUCUJADUPUDUJBF
      UOUDUEUJUHUIUFUGUC $.
      $( [22-Dec-03] $) $( [22-Dec-03] $)

    $( Rule used to change bound variables with implicit substitution. $)
    cbvex2 $p |- ( E. x E. y ph <-> E. z E. w ps ) $=
      ( wex hbex weq wb wi wa ax-17 hban exp com12 pm5.32d cbvex 19.42 3bitr3
      pm5.32 mpbir ) ADLZBFLZCEAEDGMBCFIMCENZUHUIOPUJUHQZUJUIQZOUJAQZDLUJBQZFLU
      KULUMUNDFUJAFUJFRZHSUJBDUJDRZJSDFNZUJABUJUQABOZUJUQURKTUAUBUCUJADUPUDUJBF
      UOUDUEUJUHUIUFUGUC $.
      $( [14-Sep-03] $)
  ...
  ${
    ...
    $( Deduction used to change bound variables with implicit substitution,
       particularly useful in conjunction with ~ ddelim . $)
    cbvald $p |- ( ph -> ( A. x ps <-> A. y ch ) ) $=
      ( wal wi hbim1 ax-17 weq wb com12 pm5.74d cbval 19.21v 19.21 3bitr3
      pm5.74ri ) ABDIZCEIZABJZDIACJZEIAUBJAUCJUDUEDEABEFGKUEDLDEMZABCAUFBCNHOPQ
      ABDRACEFSTUA $.
      $( [2-Jan-02] $)
    ...
    cbvexd $p |- ( ph -> ( E. x ps <-> E. y ch ) ) $=
      ( wn wal wex hbnd weq wb pm4.11 syl6ib cbvald binegd df-ex 3bitr4g ) ABIZ
      DJZICIZEJZIBDKCEKAUBUDAUAUCDEFABEFGLADEMBCNUAUCNHBCOPQRBDSCEST $.
      $( [2-Jan-02] $)
  $}
  ...
  ${
    ...
    cbvex4v.vf $f set f $.
    cbvex4v.vg $f set g $.
    $d v u ph $.  $d f g ph $.  $d x y ch $.  $d z w ch $.
    $d x y ps $.  $d f g ps $.
    $d x z w u $.  $d y z w v $.  $d z g $.  $d w f $.
    cbvex4v.1 $e |- ( ( x = v /\ y = u ) -> ( ph <-> ps ) ) $.
    cbvex4v.2 $e |- ( ( z = f /\ w = g ) -> ( ps <-> ch ) ) $.
    $( Rule used to change bound variables with implicit substitution. $)
    cbvex4v $p |- ( E. x E. y E. z E. w ph <-> E. v E. u E. f E. g ch ) $=
      ( wex weq wa bi2exdv cbvex2v bi2ex bitr ) AGNFNZENDNBGNFNZINHNCKNJNZINHNU
      AUBDEHIDHOEIOPABFGLQRUBUCHIBCFGJKMRST $.
      $( [26-Jul-95] $)
  $}
  ...
  ${
    ...
    eeanv $p |- ( E. x E. y ( ph /\ ps ) <-> ( E. x ph /\ E. y ps ) ) $=
      ( wa wex exdistr ax-17 hbex 19.41 bitr ) ABEDFCFABDFZECFACFLEABCDGALCBCDB
      CHIJK $.
      $( [26-Jul-95] $)
  $}

  ${
    $d y z ph $.  $d x z ps $.  $d x y ch $.
    $( Rearrange existential quantifiers. $)
    eeeanv $p |- ( E. x E. y E. z ( ph /\ ps /\ ch ) <->
                 ( E. x ph /\ E. y ps /\ E. z ch ) ) $=
      ( wa wex w3a 19.42vv eeanv bilan bitr biex 19.41v 3anass bi3ex 3bitr4 )
      ABCGZGZFHEHZDHZADHZBEHZCFHZGZGZABCIZFHEHDHUCUDUEIUBAUFGZDHUGUAUIDUAASFHEH
      ZGUIASEFJUJUFABCEFKLMNAUFDOMUHTDEFABCPQUCUDUEPR $.
      $( [26-Jul-95] $)
  $}
  ...
  ${
    ...
    ee4anv $p |- ( E. x E. y E. z E. w ( ph /\ ps ) <->
      ...
      ( wa wex excom biex eeanv bi2ex 3bitr ) ABGFHZEHDHZCHNDHZEHZCHADHZBFHZGZE
      HCHRCHSEHGOQCNDEIJPTCEABDFKLRSCEKM $.
      $( [31-Jul-95] $)
  $}
  ...
  ${
    ...
    cleljust $p |- ( x e. y <-> E. z ( z = x /\ z e. y ) ) $=
      ( weq wel wa wex ax-17 a13b eqsex bicomi ) CADCBEZFCGABEZLMCAMCHCABIJK $.
      $( [28-Jan-04] $) $( [28-Jan-04] $)
  $}
...
$( The theorems in this section make use of the $d statement. $)
  ...
  ${
    ...
    sb5 $p |- ( [ y / x ] ph <-> E. x ( x = y /\ ph ) ) $=
      ( weq wa wex wsb hbs1 sbequ12 eqsex bicomi ) BCDAEBFABCGZALBCABCHABCIJK
      $.
      $( [18-Aug-93] $)
  $}
  ...
  ${
    ...
    sb6 $p |- ( [ y / x ] ph <-> A. x ( x = y -> ph ) ) $=
      ( weq wi wal wsb hbs1 sbequ12 eqsal bicomi ) BCDAEBFABCGZALBCABCHABCIJK
      $.
      $( [18-Aug-93] $)
  $}
